...
public interface ServerConversation extends Conversation {
    ...
    @Override
    ServerMessageLog getMessageLogForDate(LocalDate localDate) throws CouldNotGetMessageLogException;
     ...
     */
    List<Message> checkForNewMessagesOnDate(LocalDate localDate, long lastMessage) throws CouldNotGetMessageLogException;
